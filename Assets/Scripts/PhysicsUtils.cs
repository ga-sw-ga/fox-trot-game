// script by Ditzel Games
using UnityEngine;

public static class PhysicsUtils
{
    public static void AddForceToReachVelocity(Rigidbody rigidbody, Vector3 velocity, float force = 1,
    ...
    public static void AddTorqueToReachRPS(Rigidbody rigidbody, Quaternion rotation, float rps, float force = 1)
    {
    ...
    public static Vector3 GetNormal(Vector3[] points)
    {
        ...
        var center = VectorUtils.GetCenter(points);
